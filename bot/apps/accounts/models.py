...
class Account(models.Model):
    ...
    auto_friends = models.BooleanField(
        "Автоматическое добавление в друзья", default=True
    )
    ls_user = models.BooleanField("Обращение в личных сообщениях", default=True)
    group_name = models.BooleanField(
        "Обращение к пользователю в беседах", default=False
    )
    ...
    reply = models.BooleanField(
        "Пересылать сообщения собеседника в беседах", default=True
    )
