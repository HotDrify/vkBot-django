...
urlpatterns = [
    ...
    path(
        "new_acc_login_or_token",
        views.new_acc_login_or_token,
        name="new_acc_login_or_token",
    ),
    ...
    path(
        "create_account_token", views.create_account_token, name="create_account_token"
    ),
    ...
    path(
        "<int:account_id>/delete_account", views.delete_account, name="delete_account"
    ),
]
