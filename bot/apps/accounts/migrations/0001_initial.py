    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "call",
                    models.CharField(max_length=15, verbose_name="Обращение бота"),
                ),
                (
                    "time",
                    models.PositiveIntegerField(
                        verbose_name="Задержка перед отправкой сообщения"
                    ),
                ),
                (
                    "voice",
                    models.BooleanField(verbose_name="Ответ голосовыми сообщениями"),
                ),
